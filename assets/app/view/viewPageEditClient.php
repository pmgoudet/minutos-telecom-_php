        ...
        <form class="connect-form" action="" method="POST">
          ...
          <div class="form-flex mdp-gen form-flex-password">
            ...
            <div class="mdp-gen">
              ...
              <input class="form-input" type="text" id="password" name="password" required disabled/>
            </div>
          </div>

          <div class="form-flex form-flex-status">
            <label class="form-label" for="status">Status</label>
            <select class="form-input" id="status" name="status" value="{$this->getStatus()}" disabled>
