...
include "../view/viewPageAdminDeconnecte.php";
...
class ControllerLoginAdmin
{
        ...
        if (filter_var($_POST['login-admin'], FILTER_VALIDATE_EMAIL)) {
          ...
          if (!empty($data)) {
            if (password_verify($password, $data[0]['psswrd'])) {
              ...
              //todo header('Location:controllerAccount.php');
            } else {
  ...
  public function render(): void
  {
    ...
    if (isset($_SESSION['id'])) {
      ...
      echo $this->getViewPageAdminDeco()->displayView();
    }
...
//!TEM QUE MUDAR O HEADER CONNECTADO